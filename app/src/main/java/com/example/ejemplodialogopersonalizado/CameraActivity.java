...
public class CameraActivity extends AppCompatActivity {
    ...
    private ActivityResultLauncher<Uri> tomarFotoLaucher;

    private ActivityResultLauncher<String> permisoLaucher;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tomarFotoLaucher = registerForActivityResult(new ActivityResultContracts.TakePicture(), exito ->{
        ...
        permisoLaucher = registerForActivityResult(new ActivityResultContracts.RequestPermission(), concedido ->{
            if (Boolean.TRUE.equals(concedido)) {
                lanzarCamara();
            }else
            {
                Toast.makeText(this, "Sin permiso no se puede guardar en Galeria", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void abrirCamara()
    {
        ...
        {
            permisoLaucher.launch(Manifest.permission.WRITE_EXTERNAL_STORAGE);
            return;
        }
        lanzarCamara();
    }
    ...
    private void guardarEnGaleria(File archivo)
    {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q)
        {
            ...
            getContentResolver().update(destino, v, null);
        }
    }
}
